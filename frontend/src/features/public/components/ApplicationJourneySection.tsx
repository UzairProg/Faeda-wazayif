...
export function ApplicationJourneySection() {
  ...
  const appPipeline = language === "en" ? [
    {
      id: "submit",
      step: "01",
      title: "Application Submitted",
      desc: "Preserves your CV version at application time.",
      icon: Send,
      badge: "Completed",
      details: "Instant submission confirmation keeping a timestamped copy of your official CV.",
    },
    {
      id: "review",
      step: "02",
      title: "In Review & Screening",
      desc: "Matches profile with position specifications.",
      icon: FileSearch,
      badge: "Active Now",
      details: "Checks job requirements and shows benchmark match standing without automatic blackbox rejection.",
    },
    {
      id: "interview",
      step: "03",
      title: "Interview & Assessment",
      desc: "Schedules technical interview or test.",
      icon: Calendar,
      badge: "Scheduled",
      details: "Slot reminders, interview link, and customized preparation guide for the hiring company.",
    },
    {
      id: "decision",
      step: "04",
      title: "Transparent Decision",
      desc: "Explainable offer or respectful feedback report.",
      icon: CheckCircle2,
      badge: "Guaranteed",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3.5 py-1 text-xs font-bold text-primary mb-3">
            ...
            <span>{t("public.applicationJourney.badge")}</span>
          </div>

          <h2 className="text-2xl sm:text-3xl font-extrabold font-heading text-white mb-2">
            {t("public.applicationJourney.title")}
          </h2>
          <p className="text-xs sm:text-sm text-muted-foreground">
            {t("public.applicationJourney.subtitle")}
          </p>
        </div>
          ...
          >
            <GlassCard className="p-7 sm:p-8 bg-card/40 backdrop-blur-md border-white/10 text-start flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 shadow-xl">
              ...
              <div className="flex items-center gap-2 text-xs sm:text-sm text-primary font-bold shrink-0 self-end sm:self-auto">
                ...
                <span>{t("public.applicationJourney.liveTracking")}</span>
              </div>
            </GlassCard>
          </motion.div>
        </AnimatePresence>
