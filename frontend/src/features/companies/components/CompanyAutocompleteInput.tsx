/**
 * features/companies/components/CompanyAutocompleteInput.tsx
 *
...
interface CompanyAutocompleteInputProps {
  ...
  onSelectSuggestion?: (suggestion: CompanySuggestion) => void
  onSubmitSearch?: () => void
  placeholder?: string
  className?: string
}
...
export function CompanyAutocompleteInput({
  ...
  const handleSelect = (sug: CompanySuggestion) => {
    onChange(sug.value)
    setIsOpen(false)
