...
@job_routes.route('/add_new_job', methods=['POST'])
def add_job_post():
    # Get form data
    id = session['company_id']
        # public
...
@job_routes.route('/job-list', defaults={'page': 1})
@job_routes.route('/job-list/<int:page>')
...
@job_routes.route('/read_job/<int:job_id>')
def read_job(job_id):
    application_count = 0
...
@job_routes.route('/delpost/<int:job_id>')
...
@job_routes.route('/edit_posted_jobs/<int:job_id>')
...
@job_routes.route('/editmypost/<int:job_id>')
...
@job_routes.route('/editmypost/<int:job_id>', methods=['POST'])
...
@job_routes.route('/update-list', methods=['GET'], defaults={'page': 1})
@job_routes.route('/update-list/<int:page>')
def update_list(page):
    ...
    return render_template('job_filter.html', jobs=paginated_jobs)
