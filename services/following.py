# ==============================================================================
# الوظيفة الأساسية للملف: نموذج قاعدة البيانات (Model) لإدارة المتابعات.
# الروابط أو الميزات: جدول لربط متابعات العملاء للشركات أو العكس.
# المتطلبات الخاصة: يعتمد على SQLAlchemy لربط المفاتيح الخارجية.
# ==============================================================================
